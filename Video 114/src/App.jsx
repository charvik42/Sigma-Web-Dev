    ...
    <Navbar/>
      ...
      <h1 className='font-bold text-center text-xl'>iTask - Manage your Todos at One Place</h1>
          <div className="addTodo my-5 flex flex-col gap-4">
            ...
            <div className="flex">
            <input onChange={handleChange} value={todo} type="text" className='w-full border border-violet-400 rounded-full px-5 py-1' />
            <button onClick={handleAdd} disabled={todo.length<=3} className='bg-violet-800 mx-2 hover:bg-violet-950 disabled:bg-violet-700 p-4 text-sm font-bold py-2 text-white rounded-full'>Save</button>
            </div>
          </div>
